...
abstract class Utility {
  ...
  static List<AddEmploy> addEmploy = [
    AddEmploy(eployName: 'Harshil'),
    AddEmploy(eployName: 'Raz'),
    AddEmploy(eployName: 'Dhruvil'),
    AddEmploy(eployName: 'yug'),
    AddEmploy(eployName: 'SagarBhai'),
    AddEmploy(eployName: 'Raj'),
  ];
